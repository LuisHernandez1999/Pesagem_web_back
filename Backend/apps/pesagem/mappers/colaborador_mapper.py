...
from apps.pesagem.utils.colaborador_utils import fetch_one
from django.db import connection
from apps.pesagem.utils.colaborador_utils import filtro_funcao_turno_sql,order_sql_colaborador
